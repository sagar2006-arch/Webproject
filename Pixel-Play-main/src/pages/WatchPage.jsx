				...
				<div className='aspect-video mb-8 p-2 sm:px-10 md:px-32'>
					...
					{trailers?.length === 0 && (
						<h2 className='text-xl text-center mt-5'>
							...
							<span className='font-bold text-amber-600'>{content?.title || content?.name}</span> 😥
						</h2>
					)}
				</div>
					...
					<div className='mt-12 max-w-5xl mx-auto relative'>
						...
						<div className='flex overflow-x-scroll hide-scrollbar gap-4 pb-4 group' ref={sliderRef}>
							...
							<ChevronLeft
								...
								group-hover:opacity-100 transition-all duration-300 cursor-pointer bg-amber-600 
