...
const HomeScreen = () => {  
  ...
  const [imgLoading, setImageLoaded] = useState(true);
    ...
    <>
      <div className="relative h-screen text-white">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32">          
          <div 
            className="absolute w-full h-full top-0 left-0 bg-gradient-to-b from-black via-transparent to-transparent -z-50"
          />
          <div className="max-w-2xl text-left">
            ...
            <div className="flex mt-6 gap-4">
              <Link 
                ...
                className="bg-white hover:bg-white/80 text-black font-bold py-2 px-4 rounded flex 
                items-center"
              >
